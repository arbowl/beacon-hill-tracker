    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="text-center">
        ...
        <p className="text-xl text-base-content/70">
          This page contains a mix of operational updates, methodology notes, and analytical reports drawing on Tracker data. The Tracker itself measures procedural compliance; interpretive content where it exists is explicitly denoted as such and is separate from what the Tracker measures.
        </p>
      </div>
