              ...
              <div className="flex flex-col lg:flex-row lg:flex-wrap gap-3 w-full">
                ...
                {diffReport.new_bills_count !== undefined && diffReport.new_bills_count !== null && (
                  <div className="flex flex-col items-center gap-2 p-3 rounded-lg bg-base-200/30 lg:flex-1 lg:min-w-[120px]">
                    <div className={`badge badge-lg ${diffReport.new_bills_count > 0 ? 'badge-warning' : 'badge-ghost'}`}>
                      <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {diffReport.bills_with_new_hearings !== undefined && (
                  <div className="flex flex-col items-center gap-2 p-3 rounded-lg bg-base-200/30 lg:flex-1 lg:min-w-[120px]">
                    <div className={`badge badge-lg ${diffReport.bills_with_new_hearings && diffReport.bills_with_new_hearings.length > 0 ? 'badge-primary' : 'badge-ghost'}`}>
                      <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {diffReport.bills_with_new_votes !== undefined && (
                  <div className="flex flex-col items-center gap-2 p-3 rounded-lg bg-base-200/30 lg:flex-1 lg:min-w-[120px]">
                    <div className={`badge badge-lg ${diffReport.bills_with_new_votes && diffReport.bills_with_new_votes.length > 0 ? 'badge-success' : 'badge-ghost'}`}>
                      <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
